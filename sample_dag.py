...
with DAG(dag_id='list_dag', schedule_interval='0 0 * * *', default_args=default_args, catchup=False) as dag:
    ...
    task_6 = BashOperator(task_id='task_6', bash_command='aws s3 ls s3://wcd-midterm-output/')
